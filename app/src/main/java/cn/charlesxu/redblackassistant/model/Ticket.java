...
public class Ticket {
    ...
    public String getColumn_nine_msg() {
        return column_nine_msg;
    }

    public void setColumn_nine_msg(String column_nine_msg) {
        this.column_nine_msg = column_nine_msg;
    }
    ...
    public String getIntegral_pay_flag() {
        return integral_pay_flag;
    }

    public void setIntegral_pay_flag(String integral_pay_flag) {
        this.integral_pay_flag = integral_pay_flag;
    }
}
