package cn.charlesxu.redblackassistant.http;
 ...
 */
public class QueryLeftNewDTOBean implements Parcelable {
    ...
    public QueryLeftNewDTOBean() {
    }

    protected QueryLeftNewDTOBean(Parcel in) {
    ...
    public static final Creator<QueryLeftNewDTOBean> CREATOR = new Creator<QueryLeftNewDTOBean>() {
        @Override
        public QueryLeftNewDTOBean createFromParcel(Parcel source) {
            return new QueryLeftNewDTOBean(source);
        }

        @Override
        public QueryLeftNewDTOBean[] newArray(int size) {
            return new QueryLeftNewDTOBean[size];
        }
    };
}
